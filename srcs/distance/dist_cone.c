...
/*   Updated: 2023/07/17 16:53:01 by smorphet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
float dist_cone(const t_ray *ray, t_object *cone)
{
	...
	// calc_temps_cone(ray, &cone->cone, temp);
	posdiff_x = translated_origin.x - cone->cone.normal.x;
	posdiff_z = translated_origin.z - cone->cone.normal.z;
